...
Byte-identical copy of gpu_layer0/layer0_oscillator.py -- deliberately
...
here becomes CPU load fraction). If this file ever needs to diverge
between the two, that's worth noticing before doing it, not doing it by
default -- keep them in sync unless there's a real reason not to.
